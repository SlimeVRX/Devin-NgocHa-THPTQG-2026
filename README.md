...
Trong repo: **Settings → Pages → Build and deployment → Source: Deploy from a branch → Branch: `main` (root)**. URL sẽ là `https://SlimeVRX.github.io/Devin-NgocHa-THPTQG-2026/`.
